# LAVABOTv2
this project can initialize automatic and manual control of LAVABOT achieving the environmental cleaning while maintaining the safety in the vicinity
...
// ---------- WiFi Credentials ----------
const char* ssid     = "HUAWEI-sGJ3"; // change this with your actual wifi credentials
const char* password = "5VneQzsk"; // password of your wifi internet
